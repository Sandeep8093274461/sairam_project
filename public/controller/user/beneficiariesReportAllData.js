...
app.controller("myCtrl", async ($scope, $http, Excel, $timeout) => {
    ...
    $scope.getFilteredData = async () => {
        if ($scope.fromDate != undefined && $scope.toDate != undefined) {
            $http.post('http://localhost:7900/bloodDonation/userRoute/beneficiariesReportAllData', { dist_id: $scope.district_id, fromDate: $scope.fromDate, toDate: $scope.toDate, district_id: district_id, user_id: $scope.user_id })
                .then(response => {
    ...
    $scope.view = function (y) {
        ...
        $http.get('http://localhost:7900/bloodDonation/userRoute/beneficiariesReportDatashow?beneficiariesreportid=' + $scope.beneficiariesreportid)
            .then(response => {
    ...
    $scope.edit = function (y) {
        $scope.beneficiariesreportid = y;
        window.location.href = "http://localhost:7900/bloodDonation/user/beneficiariesReport?beneficiariesreportid=" + $scope.beneficiariesreportid;
    ...
    $scope.oneDataDeleted = async (beneficiariesreportid) => {
        try {
            await $http.post('http://localhost:7900/bloodDonation/userRoute/beneficiariesReportDataDeleted', { beneficiariesreportid: beneficiariesreportid });
