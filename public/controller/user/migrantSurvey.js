...
app.controller("myCtrl", async ($scope, $http) => {
    ...
    $scope.loadStates = function () {
        $http.get("http://localhost:7900/bloodDonation/userRoute/state")
            .then(function (response) {
    ...
    $scope.loadblock = function () {
        $http.get("http://localhost:7900/bloodDonation/userRoute/loadblock?district_id=" + $scope.district_id)
            .then(function (response) {
                $scope.blockList = response.data;
            });
    }
    $scope.loadgp = function () {
        $http.get("http://localhost:7900/bloodDonation/userRoute/loadgp?block_code=" + $scope.block)
            .then(function (response) {
                $scope.gpList = response.data;
            });
    }
    $scope.loadVillages = function () {
        $http.get("http://localhost:7900/bloodDonation/userRoute/loadVillages?gp_code=" + $scope.gp)
            .then(function (response) {
    ...
    $scope.Submit = async () => {
        ...
        try {
            await $http.post('http://localhost:7900/bloodDonation/userRoute/addMigrateData', $scope.data);
    ...
    $scope.edit = function () {
        if ($scope.migrate_id != '') {
            $http.get("http://localhost:7900/bloodDonation/userRoute/getApplicationDetails?migrate_id=" + $scope.migrate_id)
                .then(function (response) {
                    ...
                    $scope.remarksByTheSurveyer = $scope.details.remarksbythesurveyer;
                        ...
                        $http.get("http://localhost:7900/bloodDonation/userRoute/loadblock?district_id=" + $scope.details.district)
                            .then(function (response) {
                                $scope.blockList = response.data;
                                $scope.block = $scope.details.block;
    ...
    $scope.update = async () => {
        ...
        try {
            await $http.post('http://localhost:7900/bloodDonation/userRoute/updateMigrateData', { updateData: $scope.data, migrate_id: $scope.migrate_id, district_id: district_id });
