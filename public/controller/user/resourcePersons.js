...
app.controller("myCtrl", async ($scope, $http) => {
    ...
    $scope.Submit = async () => {
        ...
        try {
            await $http.post('http://localhost:7900/bloodDonation/userRoute/addResouresPersonData', $scope.data);
    ...
    $scope.edit = function () {
        if ($scope.id != '') {
            $http.get("http://localhost:7900/bloodDonation/userRoute/getResoursesApplicationDetails?id=" + $scope.id)
                .then(function (response) {
    ...
    $scope.update = async () => {
        ...
        try {
            await $http.post('http://localhost:7900/bloodDonation/userRoute/updateResoursesData', { updateData: $scope.data, id: $scope.id });
