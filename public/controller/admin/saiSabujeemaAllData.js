...
app.controller("myCtrl", async ($scope, $http, Excel, $timeout) => {
    ...
    $scope.getFilteredData = async () => {
        if ($scope.fromDate != undefined && $scope.toDate != undefined) {
            $http.post('http://localhost:7900/bloodDonation/adminRoute/saiSabujeemaAllDataShow', { dist_id: $scope.dist, fromDate: $scope.fromDate, toDate: $scope.toDate, district_id: district_id, user_id: $scope.user_id })
                .then(response => {
    ...
    $scope.view = function (y) {
        ...
        try {
            $http.get('http://localhost:7900/bloodDonation/adminRoute/saiSabujeemaDatashow?sabujeema_id=' + $scope.sabujeema_id)
                .then(function (response) {
    ...
    $scope.edit = function (y) {
        $scope.sabujeema_id = y;
        window.location.href = "http://localhost:7900/bloodDonation/admin/saiSabujeema?sabujeema_id=" + $scope.sabujeema_id;
    ...
    $scope.oneDataDeleted = async (sabujeema_id) => {
        try {
            await $http.post('http://localhost:7900/bloodDonation/adminRoute/saiSabujeemaDataDeleted', { sabujeema_id: sabujeema_id });
