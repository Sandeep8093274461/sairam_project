...
app.controller("myCtrl", async ($scope, $http) => {
    ...
    $scope.allDataShow = function (y) {
        try {
            $http.get('http://localhost:7900/bloodDonation/adminRoute/resourcePersonsDatashow?id=' + id)
...
function loadPage(content, callback) {
    ...
    mywindow.document.write('<html><head><title>Resource Person / Committee members</title><meta name="user_id" content="print">');
