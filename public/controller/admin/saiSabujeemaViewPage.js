...
app.controller("myCtrl", async ($scope, $http) => {
    ...
    $scope.allDataShow = function (y) {
        try {
            $http.get('http://localhost:7900/bloodDonation/adminRoute/saiSabujeemaDatashow?sabujeema_id=' + sabujeema_id)
    ...
    $scope.back = (y) => {
        ...
        window.location.href = "http://localhost:7900/bloodDonation/admin/saiSabujeemaAllData";
